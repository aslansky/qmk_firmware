...
[1] = LAYOUT_65_ansi_splitbs(
   KC_SLEP,     KC_F1,            KC_F2,        KC_F3,      KC_F4,     KC_F5,       KC_F6,      KC_F7,           KC_F8,     KC_F9,           KC_F10,        KC_F11,         KC_F12,         UC_MOD,         UC_RMOD,        KC_NO,      \
   KC_NO,       KC_NO,            KC_NO,        X(EURO),    KC_NO,     KC_NO,       KC_NO,      XP(UUML, UUUML), KC_NO,     XP(OUML, OUUML), SGUI(KC_5),    KC_NO,          KC_NO,                          KC_DEL,         KC_NO,      \
   KC_NO,       XP(AUML, AUUML),  X(SZET),      KC_NO,      LSA(KC_F), X(GRAD),     KC_NO,      KC_NO,           KC_NO,     KC_NO,           KC_NO,         KC_NO,                          KC_NO,                          KC_NO,      \
